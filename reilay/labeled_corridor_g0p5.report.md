...
Source: `labeled_corridor_result_g0p5.json`
...
- `labeled_corridor_g0p5.points.csv`: all path point coordinates.
- `labeled_corridor_g0p5.segments.csv`: every segment length, minimum clearance, and nearest obstacle.
- `labeled_corridor_g0p5.turns.csv`: every turn angle and required card count.
